...
#include "../../CSerialInfo/LoginWidget.h"
...
QT_MOC_LITERAL(1, 12, 3), // "slo"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 5) // "emiso"

    },
    "LoginWidget\0slo\0\0emiso"
};
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::slo)) {
                *result = 0;
                return;
            }
        }
